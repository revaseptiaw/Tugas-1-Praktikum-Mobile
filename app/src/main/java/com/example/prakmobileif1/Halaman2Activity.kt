...
import com.example.prakmobileif1.databinding.ActivityHalaman2Binding

class Halaman2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityHalaman2Binding

    // Tambahkan variabel untuk maps
    private val latitude = -7.42139
    private val longitude = 109.24056
    ...
    private fun initListener() {
        ...
        binding.layoutLocation.root.setOnClickListener {
            val gMapsIntentUri = "geo:$latitude,$longitude".toUri()
